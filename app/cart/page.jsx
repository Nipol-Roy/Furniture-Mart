...
const CartPage = () => {
  ...
  const hangleUpdateQuantuty = (id, delta) => {
  ...
  return (
    <>
      <div className="w-full min-h-[75vh] max-w-7xl  mx-auto my-12 px-4">
        <div className="p-3">
          <h1 className="text-3xl md:text-4xl p font-bold text-gray-800 mb-2">
            Shopping bag
          </h1>
          <p>{totalItems} Items in the bag</p>
        </div>
        <div className="flex flex-col md:flex-row gap-4">
          <div className="w-full lg:w-2/3 shadow-md p-4 sm:p-6">
            {cartItems.length === 0 ? (
              ...
              <>
                <div className="hidden sm:grid grid-cols-[2fr_1fr_1fr_auto] gap-4 text-gray-700 font-semibold mb-4">
                  <div className=" truncate overflow-hidden">Product</div>
                  <div>Price</div>
                  <div>Quantity</div>
                  <div>Total Price</div>
                </div>
                ...
                {cartItems.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="text-gray-700 text-sm sm:text-base flex justify-between w-full sm:block pl-3">
                    ...
                    <div className="flex  items-center w-full sm:w-auto">
                      ...
                      <button
                        onClick={() => hangleUpdateQuantuty(item.id, -1)}
                    ...
                    <div className=" p-2 flex justify-center items-center md:flex-none w-full ">
                      <MdDelete
                        className="text-gray-500 hover:text-red-500 cursor-pointer  text-md sm:text-lg "
